...
<meta charset="utf-8" name="viewport" content="width=device-width, initial-scale=1.0"/>
	...
	<link rel="stylesheet" href="addfriends.css" type="text/css" />
...
<div id="container">
	<div class="rectangle">
		...
		<div class="topnav">
			...
			<a class="active" href="addfriends.php">AddFriends</a>
	...
	<div id="content">
		<div id="szukajZ">
			<form method="post" class="szukajZ" action="addfriends.php">
				<input name="find" placeholder="Find your friends...">
				<button>F</button> 
			</form>
		</div>
	</div>
